...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2018 a las 07:04:44
...
CREATE TABLE IF NOT EXISTS `talumno_responsable` (
...
CREATE TABLE IF NOT EXISTS `talum_mat_not` (
...
CREATE TABLE IF NOT EXISTS `tanio` (
...
CREATE TABLE IF NOT EXISTS `tbachilleratos` (
...
CREATE TABLE IF NOT EXISTS `tcargos` (
...
CREATE TABLE IF NOT EXISTS `tdatos_adicionales` (
...
CREATE TABLE IF NOT EXISTS `tficha` (
...
CREATE TABLE IF NOT EXISTS `thorarios` (
...
CREATE TABLE IF NOT EXISTS `topciones` (
...
CREATE TABLE IF NOT EXISTS `tperiodos` (
...
CREATE TABLE IF NOT EXISTS `tpersonal_materia` (
...
CREATE TABLE IF NOT EXISTS `tsecciones` (
...
CREATE TABLE IF NOT EXISTS `ttipobachillerato` (
...
--
ALTER TABLE `talumno`
  ADD PRIMARY KEY (`eid_alumno`), ADD KEY `fk_opcion` (`cbachillerato`) USING BTREE, ADD KEY `fkanio` (`anio`);

--
-- Indices de la tabla `talumno_responsable`
--
ALTER TABLE `talumno_responsable`
  ADD PRIMARY KEY (`id_ar`), ADD KEY `fkalumnos` (`efk_alumno`), ADD KEY `fkresponsable` (`efk_responsable`);

--
-- Indices de la tabla `talum_mat_not`
--
ALTER TABLE `talum_mat_not`
  ADD PRIMARY KEY (`id_amn`), ADD KEY `fkalumno` (`efk_idalumno`), ADD KEY `fkmaetria` (`efk_idmateria`), ADD KEY `fknota` (`efk_idnota`);
...
ALTER TABLE `tbachilleratos`
  ADD PRIMARY KEY (`eid_bachillerato`), ADD KEY `fktipo` (`efk_tipo`);

--
-- Indices de la tabla `tbitacora`
--
ALTER TABLE `tbitacora`
  ADD PRIMARY KEY (`eid_bitacora`), ADD KEY `efkusuario` (`efk_idusuario`);
...
ALTER TABLE `tdatos_adicionales`
  ADD PRIMARY KEY (`eid_datosadicionales`), ADD KEY `fkfichadatos` (`efk_ficha`);
...
ALTER TABLE `tmaterias`
  ADD PRIMARY KEY (`eid_materia`), ADD KEY `fkopcion` (`efk_idopcion`), ADD KEY `fkhorario_idx` (`efk_idhorario`);

--
-- Indices de la tabla `tnotas`
--
ALTER TABLE `tnotas`
  ADD PRIMARY KEY (`eid_notas`), ADD KEY `fkperiodo` (`efk_idperiodo`);

--
-- Indices de la tabla `topciones`
--
ALTER TABLE `topciones`
  ADD PRIMARY KEY (`eid_opcion`), ADD KEY `fkbto` (`efk_bto`), ADD KEY `fkgrado` (`efk_grado`), ADD KEY `fkseccion` (`efk_seccion`);
...
ALTER TABLE `tpermisos`
  ADD PRIMARY KEY (`eid_permisos`), ADD KEY `fkusuario` (`efk_idusuario`);

--
-- Indices de la tabla `tpersonal`
--
ALTER TABLE `tpersonal`
  ADD PRIMARY KEY (`eid_personal`), ADD KEY `fkcargo` (`efk_idcargo`);

--
-- Indices de la tabla `tpersonal_materia`
--
ALTER TABLE `tpersonal_materia`
  ADD PRIMARY KEY (`eid_pm`), ADD KEY `fk_personal` (`efk_idpersonal`), ADD KEY `fk_materia` (`efk_idmateria`);
...
ALTER TABLE `tusuarios`
  ADD PRIMARY KEY (`eid_usuario`), ADD KEY `fkpersonal` (`efk_personal`);
...
--
ALTER TABLE `tbitacora`
  MODIFY `eid_bitacora` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
