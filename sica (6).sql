...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2018 a las 15:45:05
...
(9, '009', 'Matematica', 'Numeros,Integrales', 2, 1, 1);
...
(7, '12344555-5', 'Josue Alexander', 'Hernandez', '12345678', 'alexito@gmail.com', 'San Rafael', '2018-09-14', 0, 2, 2),
...
--
ALTER TABLE `tcargos`
  MODIFY `eid_cargo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tmaterias`
  MODIFY `eid_materia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tpersonal`
  MODIFY `eid_personal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `tpersonal_materia`
--
ALTER TABLE `tpersonal_materia`
  MODIFY `eid_pm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
