...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2018 a las 22:11:03
...
ALTER TABLE `tbitacora`
  ADD PRIMARY KEY (`eid_bitacora`), ADD KEY `fk_idusuario` (`efk_idusuario`);
...
--
ALTER TABLE `tficha`
  ADD PRIMARY KEY (`eid_ficha`), ADD KEY `fkanio` (`efk_anio`), ADD KEY `fkalumnoficha` (`efk_alumno`), ADD KEY `fkopciones` (`efk_opcion`);
