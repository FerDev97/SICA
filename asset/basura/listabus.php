            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Lista Agencias</h3>
...
$result = $conexion->query("select b.idbus as bus,e.nombre as empleado, b.placa as placa, b.foto as foto, b.tipo as tipo from bus as b, empleado as e where b.idempleado=e.idempleado order by e.nombre");
if ($result) {
    while ($fila = $result->fetch_object()) {
        echo "<tr>";
        echo "<td>
          <div class='col-md-2' style='margin-top:1px'>
            <button class='btn ripple-infinite btn-round btn-warning' onclick='modify(" . $fila->bus . ")'>
            <div>
              <span>Editar</span>
            </div>
            </button>
        ...
        echo "<td><img src='imagen.php?idbus=" . $fila->bus . "' width=100 height=180></td>";

        echo "<td>
          <div class='col-md-2' style='margin-top:1px'>
            <button class='btn ripple-infinite btn-round btn-success' onclick='confirmar(" . $fila->bus . ")';>
            <div>
              <span>Borrar</span>
            </div>
            </button>
...
if ($bandera == 'enviar') {
    ...
    echo "document.location.href='editbus.php?id=" . $baccion . "';";
    echo "</script>";
    # code...
}
if ($bandera == "desaparecer") {
    $consulta = "DELETE FROM bus where idbus='" . $baccion . "'";
