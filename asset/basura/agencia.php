                        ...
                        <form class="cmxform" id="formcliente" method="post" action="">
                          ...
                          <div class="col-md-4">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombreagencia" name="nombreagencia" required>
                              <span class="bar"></span>
                              <label>Nombre</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="direccionagencia" name="direccionagencia" required>
                              <span class="bar"></span>
...
if ($bandera == "add") {
    $consulta  = "INSERT INTO agencia VALUES('null','" . $nombreagencia . "','" . $direccionagencia . "','" . $latitudagencia . "','" . $longitudagencia . "')";
