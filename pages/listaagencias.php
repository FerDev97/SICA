...
$result = $conexion->query("select * from agencia order by nombre");
if ($result) {
    while ($fila = $result->fetch_object()) {
        echo "<tr>";
        echo "<td>
          <div class='col-md-2' style='margin-top:1px'>
            <button class='btn ripple-infinite btn-round btn-warning' onclick='modify(" . $fila->idagencia . ")'>
            <div>
              <span>Editar</span>
            </div>
            </button>
        ...
        echo "<td>
          <div class='col-md-2' style='margin-top:1px'>
            <button class='btn ripple-infinite btn-round btn-success' onclick='confirmar(" . $fila->idagencia . ")';>
            <div>
              <span>Borrar</span>
            </div>
            </button>
...
if ($bandera == 'enviar') {
    ...
    echo "document.location.href='editagencia.php?id=" . $baccion . "';";
    echo "</script>";
    # code...
}
if ($bandera == "desaparecer") {
    $consulta = "DELETE FROM agencia where idagencia='" . $baccion . "'";
