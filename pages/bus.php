                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel panel-info">
                    <div class="col-md-12 panel-heading">
                      <h4>Informaci&oacute;n Buses</h4>
                    </div>
                        ...
                        <form class="cmxform" id="formcliente" method="post" action="">
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              ...
                              <br>
                              <br>
                              <select  id="empleado" class="select2" style="width: 300px; font-size: 20px" name="empleado">
                              <option value="">Seleccione</option>
                              <?php
include "../config/conexion.php";
$result = $conexion->query("select * from empleado");
if ($result) {
    while ($fila = $result->fetch_object()) {
        echo '<option value="' . $fila->idempleado . '">' . $fila->nombre . " " . $fila->apellido . '</opcion>';
    }
...
?>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="placa" name="placa" required>
                              <span class="bar"></span>
                              <label>Placa</label>
                            </div>
...
if ($bandera == "add") {
    ...
    if (in_array($_FILES['imagen']['type'], $permitidos) && $_FILES['imagen']['size'] <= $limite_kb * 1024) {
        ...
        $consulta  = "INSERT INTO bus VALUES('null','" . $placa . "','" . $empleado . "','" . $data . "','" . $tipo . "')";
