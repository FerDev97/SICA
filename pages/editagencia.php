...
$result = $conexion->query("select * from agencia where idagencia=" . $id);
if ($result) {
    while ($fila = $result->fetch_object()) {
        $idagenciaR = $fila->idagencia;
        $nombreR    = $fila->nombre;
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
      ...
      <script type="text/javascript">
        function verificar(){
          if(document.getElementById('nombreagencia').value=="" ||
            document.getElementById('latitud').value=="" ||
            document.getElementById('longitud').value=="" ||
            document.getElementById('direccionagencia').value==""){
      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <!-- start: Content -->
            <div id="content">
                ...
                <input type="hidden" name="baccion" id="baccion" value="<?php echo $idagenciaR; ?>">

                <div class="col-md-12">
                  <div class="col-md-12 panel panel-info">
                    <div class="col-md-12 panel-heading">
                      <h4>Editar Informaci&oacute;n Agencia</h4>
                    </div>
                        ...
                        <form class="cmxform" id="formcliente" method="post" action="">
                          ...
                          <div class="col-md-4">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombreagencia" name="nombreagencia" required value="<?php echo $nombreR; ?>">
                              <span class="bar"></span>
                              <label>Nombre</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="direccionagencia" name="direccionagencia" required value="<?php echo $direccionR; ?>">
                              <span class="bar"></span>
                              <label>Direccion</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="latitud" name="latitud" required value="<?php echo $latitudR; ?>">
                              <span class="bar"></span>
                              <label>Latitud</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="longitud" name="longitud" required value="<?php echo $longitudR; ?>">
                              <span class="bar"></span>
...
$nombreagencia    = $_REQUEST["nombreagencia"];
$latitudagencia   = $_REQUEST["latitud"];
$longitudagencia  = $_REQUEST["longitud"];
$direccionagencia = $_REQUEST["direccionagencia"];

if ($bandera == "add") {
    $consulta  = "UPDATE agencia set nombre ='" . $nombreagencia . "',direccion='" . $direccionagencia . "',latitud='" . $latitudagencia . "',longitud='" . $longitudagencia . "' where idagencia=" . $baccion . "";
...
function msg($texto)
{
    ...
    echo "alert('$texto');";
    echo "document.location.href='listaagencias.php';";
    echo "</script>";
}
?>