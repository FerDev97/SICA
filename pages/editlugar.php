...
$result = $conexion->query("select * from lugar where idlugar=" . $id);
if ($result) {
    while ($fila = $result->fetch_object()) {
        $idlugarR     = $fila->idlugar;
        $nombreR      = $fila->nombre;
      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <!-- start: Content -->
            <div id="content">
                ...
                <input type="hidden" name="baccion" id="baccion" value="<?php echo $idlugarR; ?>">

                <div class="col-md-12">
                  <div class="col-md-12 panel panel-info">
                    <div class="col-md-12 panel-heading">
                      <h4>Editar Informaci&oacute;n Lugar</h4>
                    </div>
                        ...
                        <form class="cmxform" id="formcliente" method="post" action="">
                          ...
                          <div class="col-md-4">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombrelugar" name="nombrelugar" required value="<?php echo $nombreR; ?>">
                              <span class="bar"></span>
                              <label>Nombre</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="descripcionlugar" name="descripcionlugar" required value="<?php echo $descripcionR; ?>">
                              <span class="bar"></span>
...
$descripcionlugar = $_REQUEST["descripcionlugar"];
$longitud         = $_REQUEST["latitud"];

if ($bandera == "add") {
    $consulta  = "UPDATE lugar set nombre ='" . $nombrelugar . "',descripcion='" . $descripcionlugar . "',latitud='" . $latitud . "',longitud='" . $longitud . "' where idlugar=" . $baccion . "";
