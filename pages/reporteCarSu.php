...
class myPDF extends FPDF{
    ...
    function header(){
        ...
        $this->Cell(195,5,utf8_decode("Reporte de personal con el cargo de subdirector."),0,0,"C");
        $this->Ln();
    }
    function footer(){
        $this->SetY(-15);
    ...
    function viewTable(){
        ...
        $this->SetFont("Times","",11);
                      ...
                      $result = $conexion->query("select cdui as dui, cnombre as nombre , capellido as apellido, ccorreo as correo from tpersonal where efk_idcargo='4'");
                      if ($result) {
