                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel panel-info">
                    <div class="col-md-12 panel-heading">
                      <h4>Informaci&oacute;n Lugar</h4>
                    </div>
                        ...
                        <form class="cmxform" id="formcliente" method="post" action="">
                          ...
                          <div class="col-md-4">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombrelugar" name="nombrelugar" required>
                              <span class="bar"></span>
                              <label>Nombre</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="descripcionlugar" name="descripcionlugar" required>
                              <span class="bar"></span>
...
if ($bandera == "add") {
    $consulta  = "INSERT INTO lugar VALUES('null','" . $nombrelugar . "','" . $descripcionlugar . "','" . $latitud . "','" . $longitud . "')";
