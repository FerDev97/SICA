...
$result = $conexion->query("select * from empleado where idempleado=" . $id);
if ($result) {
      ...
      <script type="text/javascript">
        ...
        function verificar(){
          if(document.getElementById('nombreempleado').value=="" ||
            ...
            document.getElementById('idagenciaempleado').value==""){
      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <!-- start: Content -->
            <div id="content">
                ...
                <input type="hidden" name="baccion" id="baccion" value="<?php echo $idempleadoR; ?>">
                        ...
                        <form class="cmxform" id="formcliente" method="post" action="">
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombreempleado" name="nombreempleado" required value="<?php echo $nombreempleadoR; ?>">
                              <span class="bar"></span>
                              <label>Nombre</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="apellidoempleado" name="apellidoempleado" required value="<?php echo $apellidoempleadoR; ?>">
                              <span class="bar"></span>
                              <label>Apellido</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text mask-dui" id="duiempleado" name="duiempleado" required value="<?php echo $duiempleadoR; ?>">
                              <span class="bar"></span>
                              <label>Dui</label>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                          <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text mask-dui" id="nitempleado" name="nitempleado" required value="<?php echo $nitempleadoR; ?>">
                              <span class="bar"></span>
                              <label>Nit</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text " id="cargoempleado" name="cargoempleado" required value="<?php echo $cargoempleadoR; ?>">
                              <span class="bar"></span>
                              <label>Cargo</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              ...
                              <br>
                              <br>
                              <select   id="idagenciaempleado" class="select2" style="width: 300px; font-size: 20px" name="idagenciaempleado" >
                              <option value="">Seleccione</option>
                              <?php
include "../config/conexion.php";
$result = $conexion->query("select idagencia, nombre from agencia");
if ($result) {
    while ($fila = $result->fetch_object()) {
        if ($fila->idagencia == $idagenciaempleadoR) {
            echo '<option value="' . $fila->idagencia . '" selected>' . $fila->nombre . '</opcion>';
        } else {
            echo '<option value="' . $fila->idagencia . '">' . $fila->nombre . '</opcion>';
        }
...
if ($bandera == "add") {
    ...
    $consulta  = "UPDATE empleado set nombre='" . $nombreempleado . "',apellido='" . $apellidoempleado . "',dui='" . $duiempleado . "',nit='" . $nitempleado . "',cargo='" . $cargoempleado . "',idagencia='" . $idagenciaempleado . "' where idempleado='" . $baccion . "'";
