...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-01-2019 a las 19:10:30
...
(1, '001', 'Contador', 'Bachillerato orientado a la contabilidad financiera aplicadaaa', 2, 0),
...
(8, 'BE-988', 'Bachillerato en Electricidad', 'Bachillerato con enfasisi en electrinica digital', 1, 1),
(9, 'ELE238', 'Electrotecia', 'Bachillerato enfocado a la elctronica', 1, 0);
...
--
ALTER TABLE `talumno`
  MODIFY `eid_alumno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `tbitacora`
  MODIFY `eid_bitacora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
--
