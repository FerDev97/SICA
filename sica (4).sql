...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2018 a las 17:29:59
...
CREATE TABLE `talumno` (
  ...
  `cbachillerato` varchar(50) NOT NULL,
...
(9, 13, '2018-11-28 10:29:00', 'IniciÃ³ sesion Administrador');
...
--
ALTER TABLE `tbitacora`
  MODIFY `eid_bitacora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
