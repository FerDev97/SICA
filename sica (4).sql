...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2018 a las 04:05:08
...
(10, '23432434-2', 'Fernando JosuÃ©', 'Arevalo', '71558042', 'fer.aravalo1997@gmail.com', 'Barrio El santuario, 3ra. calle ote. Pasaje Zelaya, Casa #2', '2000-10-01', 0, 2, 3),
...
(1, 'Fernando97', 'ODFNakxnUjRiRThoc3Q0NE5vT2R6Zz09', 1, 1),
(2, 'carcamo1', 'Y05nQjJ4QklQOUZaQm9GeWhjWmd2dz09', 1, 4),
(3, 'fercho', 'RzNnUUUxLzRWYWpsMWt5clV0RVFwZz09', 0, 10),
(4, 'benja', 'SE54M1dqeFZEWEUrT3JtSnVuYVJtdz09', 0, 7),
...
--
ALTER TABLE `tpersonal`
  MODIFY `eid_personal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `tusuarios`
  MODIFY `eid_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
